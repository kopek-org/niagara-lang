...
# -*- coding: utf-8 -*-
#
# niagara-lang documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'niagara-lang.tex', 'niagara-lang Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'niagara-lang', 'niagara-lang Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'niagara-lang', 'niagara-lang Documentation',
     author, 'niagara-lang', 'One line description of project.',
     'Miscellaneous'),
]
