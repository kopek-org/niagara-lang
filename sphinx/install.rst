...
If :code:`niagara-lang` is available in your opam repository, you can just call::

  opam install niagara-lang

Build and install with :code:`dune`
-----------------------------------

Checkout the sources of :code:`niagara-lang` in a directory.
