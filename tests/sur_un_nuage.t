  ...
  2: ++ no events:
       - recette_brute_distributeur { 600000., %not_computed% }:
       ...
       - recette_nette_commission_distributeur { 300000., %not_computed% }:
  ...
  3: ++ no events:
       - recette_brute_distributeur { 1000000., %not_computed% }:
       ...
       - recette_nette_commission_distributeur { 700000., %not_computed% }:
     ...
     ++ after event recuperation_frais_edition_distributeur :
       ...
       - recette_nette_part_producteur { 700000., %not_computed% }:
  ...
  4: ++ no events:
       - recette_brute_distributeur { 7400000., %not_computed% }:
       ...
       - recette_nette_commission_distributeur { 5550000., %not_computed% }:
         
       - recette_nette_part_producteur { 5550000., %not_computed% }:
     ...
     ++ after event recuperation_minimum_garanti :
       ...
       - recette_nette_commission_distributeur { 450000., %not_computed% }:
         
       - recette_nette_part_producteur { 450000., %not_computed% }:
       ...
       - dromadaire_film { 45000., %not_computed% }:
         
       - barbie { 90000., %not_computed% }:
  ...
  6: ++ no events:
       - vente_tvsvod { 1000000., %not_computed% }:
       ...
       - recette_nette_part_producteur { 800000., %not_computed% }:
       ...
       - dromadaire_film { 320000., %not_computed% }:
         
       - barbie { 160000., %not_computed% }:
  ...
  8: ++ no events:
       - recette_brute_vendeur { 1600000., %not_computed% }:
       ...
       - recette_nette_commission_vendeur { 1200000., %not_computed% }:
       ...
       - vendeur_scorpion { 1600000., %not_computed% }:
     ...
     ++ after event recuperation_frais_edition_scorpion :
       - recette_brute_vendeur { 3183823.(5294117647058823), %not_computed% }:
       ...
       - recette_nette_part_producteur { 2706250., %not_computed% }:
         
       - recette_nette_commission_vendeur { 2706250., %not_computed% }:
       ...
       - vendeur_scorpion { 477573.(5294117647058823), %not_computed% }:
         
       - barbie { 541250., %not_computed% }:
     ...
     ++ after event recup_risque_prod :
       - recette_brute_vendeur { 1000000.(4705882352941176), %not_computed% }:
       ...
       - recette_nette_part_producteur { 850000.4, %not_computed% }:
         
       - recette_nette_commission_vendeur { 850000.4, %not_computed% }:
       ...
       - vendeur_scorpion { 150000.0(7058823529411764), %not_computed% }:
         
       - dromadaire_film { 170000.08, %not_computed% }:
         
       - barbie { 170000.08, %not_computed% }:
  ...
  10: ++ no events:
        ...
        - recette_nette_commission_distributeur { 800000., %not_computed% }:
